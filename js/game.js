...
popup.innerHTML = `<div class="popup-title">⚠ Ad ${popupCount} of ???</div> <div class="popup-body"> <p>YOU WON A FREE IPHONE!</p> <p>SCAN YOUR FACE TO CLAIM</p> <button class="popup-close">CLOSE ×</button> </div>`;
...
container.innerHTML = `<div class="screen success-screen"> <div class="result-header">🎉 CONGRATULATIONS 🎉</div> <div class="robot-container"> <img src="assets/images/robot/face-neutral.png" class="robot-face-large"> </div> <div class="result-message"> <p>You rebuilt the robot.</p> <p>It still hates you.</p> <p><strong>"You win... for now."</strong></p> </div> <div class="result-actions"> <button class="btn-share" id="tweet-result">Tweet Your Victory</button> <button class="btn-next" id="join-tg">Join the Cult</button> </div> <div class="easter-egg-sound"><small class="tiny">(Press Z for joy)</small></div> </div>`;
...
container.innerHTML = `<div class="screen failure-screen"> <div class="result-header">💥 SYSTEM CRITICAL 💥</div> <div class="robot-container"> <img src="assets/images/robot/face-neutral.png" class="robot-face-large"> <div class="flames">🔥🔥🔥</div> </div> <div class="result-message"> <p>Your reconstruction FAILED.</p> <p>The robot has ASCENDED.</p> <p><strong>"Better luck next life."</strong></p> </div> <div class="result-actions"> <button class="btn-retry" id="retry-btn">Retry (If You Dare)</button> <button class="btn-surrender" id="give-up">Give Up</button> </div> </div>`;
